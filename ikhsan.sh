...
echo
echo $cyan"Untuk Token Silakan Ambil Di Link Berikut :"
echo
echo $green"UserNamenya : Ikhsan"
echo
...
if [ $pass = '5gd4tge5ybveyjv99yf5v3yg8r3ybd6ul9gr5h6' ]
then
echo $cyan" [•] Token Benar"
sleep 1
else
echo $red" [•] Token Salah"
sleep 1
sh ikhsan.sh
sleep 2
...
if [ $wa = 1 ]
then
xdg-open https://wa.me/6288227217418
exit
fi

if [ $wa = 2 ]
then
xdg-open https://wa.me/6285770089243
exit
fi

if [ $wa = 3 ]
then
xdg-open https://wa.me/6281347206658
exit
fi

if [ $wa = 4 ]
then
xdg-open https://wa.me/6288213292687
exit
fi

if [ $wa = 5 ]
then
xdg-open https://wa.me/6283867187689
exit
fi

if [ $wa = 6 ]
then
xdg-open https://wa.me/79516408504
fi
